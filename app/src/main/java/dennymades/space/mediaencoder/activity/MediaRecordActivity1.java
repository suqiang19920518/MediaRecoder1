 ...
 * @description: 多媒体录制界面——TextureView
 */
public class MediaRecordActivity1 extends AppCompatActivity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback, View.OnClickListener {
    private static final String TAG = MediaRecordActivity1.class.getSimpleName();  // TAG = "MediaRecordActivity1"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity1_media_record);
        initView();
        initEvent();
    ...
    private void doPreview() {
        ...
        try {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    DialogHelper.showMessageDialog(MediaRecordActivity1.this, "提示", "请授予相机和录音权限,否则不能进行录制", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            MediaRecordActivity1.this.finish();
                        }
                    });
