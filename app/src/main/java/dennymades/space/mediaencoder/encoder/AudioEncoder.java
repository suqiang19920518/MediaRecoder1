...
//    private static final String TAG = AudioEncoder.class.getSimpleName();
    ...
    public void start(){
        ...
        Log.e("AudioEncoder", "encoder started");
        audioEncoder.start();
        isEncoding = true;
    }
    ...
    public void stop(){
        ...
        Log.e("AudioEncoder","encoder stopped");
        audioEncoder.stop();
//        muxer.stopMuxing();
        isEncoding = false;
    }
    ...
    public void encode(ByteBuffer rawBuffer, int length, long presentationTimeUs){
        ...
        Log.e("AudioEncoder","presentation time"+presentationTimeUs);
        //get input buffer
        if(isEncoding){
            ...
            Log.e("AudioEncoder","inputBufferIndex "+inputBufferIndex);
            if(inputBufferIndex>=0){
                ...
                if(length<=0){
                    ...
                    Log.e("AudioEncoder","encoding media of length : "+  length);
                ...
                Log.e("AudioEncoder","input buffer index less than zero");
            }
        }
    ...
    public void sendToMediaMuxer(){
        ...
        if(outputBufferIndex==MediaCodec.INFO_OUTPUT_FORMAT_CHANGED){
            ...
            Log.e("AudioFormat","output format changed");
            muxer.addAudioEncoder(this);
            muxer.startMuxing();

            Log.d(TAG, "muxer started");
            Log.e("AudioEncoder","muxer started");
        }
